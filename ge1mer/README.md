...
На уличной панеле при вызрве будет отображаться error, в целом работа домофонной системы не будет нарушена. <br />
Вывод — intercomm (УКП). <br />
На некоторых трубках не воспринимаются нажатия на кнопку. Тогда можно сделать собственную кнопку и вмонтировать в базу,
подключается к пинам Key  <br />
